...
**Senior Data Scientist Project (2024–Present)** | Deployed to production, adopted by 3 legal teams (50+ users).
...
I architected and led the development of a retrieval-grounded (RAG) contract QA + clause-editing workflow for compliance.
...
- **Stability Fix**: Implemented a **hybrid similarity tie-breaker** (semantic + TF–IDF) that reduced checklist-to-evidence variance from **~10%** to **<1%** across reruns. 

### 2. Human-in-the-Loop Workflow
- **Element-Level Patching**: Developed a mechanism for iterative clause-level patches with automatic re-evaluation to support compliance-driven edits.
...
- **FastAPI Backend**: Built for high-throughput asynchronous processing; combined automatic suggestions with human-in-the-loop review.
...
- **User Base**: Actively used by over **50+ legal experts** within 3 legal teams at Saint-Gobain.
...
- **AI/LLM**: OpenAI API, LangChain (customized), Sentence-Transformers, LLM embeddings
