...
In longitudinal observational studies, treatment assignments are often confounded by time-varying factors. Standard counterfactual regression methods struggle with **long-term dependencies** and **cumulative selection bias** over long horizons.

## The Solution: Information-Theoretic Regularization

We proposed a novel framework that leverages **Contrastive Predictive Coding (CPC)** and information-theoretic regularization to capture long-term dependencies and reduce longitudinal selection bias.
...
3. **Efficient Inference**: Unlike autoregressive models that require sequential sampling for multi-step forecasts, our method allows for **fast, parallelized counterfactual regression** over long horizons.
